...
export default [
    {
        ...
        title: "Email ERA",
        icon: email,
        description: "Email ERA is an intelligent, self-learning end-to-end mail management tool that bridges the gap between mailbox and CRM using NLP capabilities. It reads through e-mails, processes content, categorizes them as per business use cases and generates auto-response suggestions to the majority emails. Developed a mobile responsive front-end application with ReactJS, Material-UI for CSS and MobX for state management. Also, the web application leverages the usage of WebSockets to fetch real-time email conversations.",
        githubPath: null,
        demoPath: null,
        year: "2019",
        techUsed: "React, Material-UI, MobX, WebSockets"
    },
    {
        id: 8,
        title: "Knowledge Base Bot",
        icon: search,
        description: "Knowledge Base portal is used to create, organize, search and share any content such as pdf, docs, images, videos and more internally by admins and agents of an enterprise. Some features of the platform include versioning documents, designing quizzes for a document and generating built-in reports for quizzes, documents and agents activity. Developed the front-end of the portal in ReactJS using Material-UI for CSS and MobX for state management.",
        githubPath: null,
        demoPath: null,
        year: "2019",
